...
export function Demo() {
  ...
  if (step === 'done') {
    return (
      <div style={{ ...fade, fontFamily: "'Nunito', sans-serif", background: '#F6FBFA', minHeight: '844px', width: '390px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '0 32px', textAlign: 'center', gap: 20 }}>
